...
[data-testid="stExpander"] .stColumn input[data-testid="stNumberInputField"] {
    margin-top: 0.0rem !important;  /* push input slightly down */
}
...
[data-testid="stExpander"] .st-key-f_category + div {
    ...
    .db-info-box ul {
        margin: 4px 0 0 0px;   /* ⬅ bullets closer to left */
        padding: 0;
    }
...
st.markdown("""
    ...
    div.stElementContainer.st-key-rec_btn button:focus {
        background-color: #F53D18 !important;   /* your favourite purple 4F1022*/
        color: white !important;
...
if st.session_state.get("show_user_section", False):
    ...
    col_username, col_list, col_reveal, col_rec = st.columns([1, 1.5, 1.8, 1.6], gap='small')
